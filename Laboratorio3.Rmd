...
Con 90% de confianza: [2102.023, 2290.739]
Con 95% de confianza: [2083.883, 2308.879]
Con 99% de confianza: [2048.328, 2344.434]
...
Si p-valor es menor que el nivel de significancia se rechaza la hipotesis nula, ____chamullar____.

f)

El test Mann-Whitney-Wilcoxon sirve para determinar si 2 muestras siguen la misma distribución sin asumir que siguen una distribución normal (SADAKA VE SI PUEDES ESCRIBIR LGO MAS ACA).
```{r}
