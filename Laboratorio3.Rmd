...
```{r}
reviews_UK <- subset(reviews, User.country == "UK")
reviews_australia <- subset(reviews, User.country == "Australia")
reviews_germany <- subset(reviews, User.country == "Germany")
reviews_mexico <- subset(reviews, User.country == "Mexico")
reviews_india <- subset(reviews, User.country == "India")
reviews_arabia <- subset(reviews, User.country == "Saudi Arabia")
reviews_ireland <- subset(reviews, User.country == "Ireland")
reviews_nether <- subset(reviews, User.country == "Netherlands")
